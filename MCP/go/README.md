# IAM Roles Anywhere MCP Server

This MCP (Model Content Protocol) server provides access to IAM Roles Anywhere API functionality through HTTP, HTTPS, and STDIO transport modes.
