...
func CreateTagresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_TagResource",
		mcp.WithDescription("<p>Attaches tags to a resource.</p> <p> <b>Required permissions: </b> <code>rolesanywhere:TagResource</code>. </p>"),
		mcp.WithString("resourceArn", mcp.Required(), mcp.Description("Input parameter: The ARN of the resource.")),
		mcp.WithArray("tags", mcp.Required(), mcp.Description("Input parameter: The tags to attach to the resource.")),
	)
