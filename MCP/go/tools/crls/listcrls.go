...
func ListcrlsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/crls%s", cfg.BaseURL, queryString)
		...
		var result models.ListCrlsResponse
...
func CreateListcrlsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_crls",
		mcp.WithDescription("<p>Lists all certificate revocation lists (CRL) in the authenticated account and Amazon Web Services Region.</p> <p> <b>Required permissions: </b> <code>rolesanywhere:ListCrls</code>. </p>"),
