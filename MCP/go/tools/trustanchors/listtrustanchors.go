...
func ListtrustanchorsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/trustanchors%s", cfg.BaseURL, queryString)
		...
		var result models.ListTrustAnchorsResponse
...
func CreateListtrustanchorsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_trustanchors",
		mcp.WithDescription("<p>Lists the trust anchors in the authenticated account and Amazon Web Services Region.</p> <p> <b>Required permissions: </b> <code>rolesanywhere:ListTrustAnchors</code>. </p>"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListtrustanchorsHandler(cfg),
	}
}
